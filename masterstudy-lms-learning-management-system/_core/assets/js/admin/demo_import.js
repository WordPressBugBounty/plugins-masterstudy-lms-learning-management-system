  ...
  methods: {
    ...
    importData: function importData() {
      ...
      if (typeof _this.steps[_this.currentStep] !== 'undefined' && !_this.isLoading) {
        ...
        _this.$http.get(stm_lms_ajaxurl + '?action=stm_lms_import_sample_data&nonce=' + stm_lms_nonces['stm_lms_import_sample_data'] + '&stm_lms_step=' + _this.steps[_this.currentStep]).then(function (r) {
          r = r.body;
